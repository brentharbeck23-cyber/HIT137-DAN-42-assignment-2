...
#Main program body (run 'encrypt' then write the txt file, then run 'decrypt'
# and write the text file then verify)
...
# Check that the number is between 1 and 12 and run the encrypt function or print error then exit
